        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              if (cust.length<=0) Text('No customers') else Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10),
                    cust1.length<=0? Text('Not Found'):ListView.builder(
                      shrinkWrap: true,
                      itemCount: cust1.length,
                      itemBuilder: (context, index) {
                        return GestureDetector(
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>Custpage(customer: cust[index], reloadDashboard: reloadDashboard,)));
                          },
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                Row(
                                  children: [
                                    Text(cust1[index].balance.abs().toString(),style: TextStyle(color:cust1[index].balance>=0?Colors.green:Colors.red ,fontSize: 20),),
                                    SizedBox(width: 15),
                                    Icon(
